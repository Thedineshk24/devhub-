...
import heroImg from "../public/img/community.jpg";
      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 id="welcome_message" className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              DevHub: connects developers with online events.
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              ...
              >
                just sign in with 1Password
              </a>{" "}
              and enjoy. Learn new skills, meet new friends, and have fun with
              DevHub. Join today and get ready for an awesome developer
              experience.
            </p>
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Trusted by <span className="text-indigo-600">2000+</span> developers
            worldwide
          </div>
