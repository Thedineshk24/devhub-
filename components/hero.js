        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              DevHub: connects developers with local events and
              communities.
            </h1>
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              DevHub is the ultimate website for developers who love events.
              Find and join the best hackathons, tech talks, and more in your
              city. No passwords needed - <span className="text-1xl font-semibold underline">just sign in with 1Password</span> and enjoy.
              Learn new skills, meet new friends, and have fun with DevHub. Join
              today and get ready for an awesome developer experience.
            </p>
